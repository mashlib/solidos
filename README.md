...
- [Live vocabulary](https://mashlib.github.io/solidos/)
- [mashlib-next issue #1](https://github.com/mashlib-next/mashlib-next/issues/1)
- [W3C JSON-LD @view proposal](https://github.com/w3c/json-ld-syntax/issues/384)
